...
namespace PokeList.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchQuery)
        {
            ...
            {
                pokemon = pokemon.Where(s => s.PokemonName.Contains(searchQuery));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,PokemonName,Type,Image,PokeDexEntry")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PokemonName,Type,Image,PokeDexEntry")] Pokemon pokemon)
        {
            if (id != pokemon.Id)
            {
                return NotFound();
